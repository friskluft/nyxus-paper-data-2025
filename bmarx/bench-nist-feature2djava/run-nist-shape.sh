...
ODIR="/data/OUT-nistjavaplugin-shape"
...
features_shape="Feature2DJava_Area,Feature2DJava_Aspect_Ratio_BB,Feature2DJava_Bounding_Box,Feature2DJava_Center_BB,Feature2DJava_Centroid,Feature2DJava_Circularity,Feature2DJava_Distance_From_Border,Feature2DJava_Eccentricity,Feature2DJava_ExtendBB,Feature2DJava_Orientation,Feature2DJava_Perimeter"
docker run -it --mount type=bind,source=/home/kharchenkoa2/work/data,target=/data 55cc0153ebb1 --imageDir $IDIR --partitionsDir $SDIR --iP ".*" --pP ".*" --outputDir $ODIR --features $features_shape

end=$(date +%s)
echo "Elapsed Time: $(($end-$start)) seconds"
echo "$(($end-$start)) seconds" >> timing_shape.txt
