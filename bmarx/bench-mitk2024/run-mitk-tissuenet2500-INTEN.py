...
outpath = "/home/kharchenkoa2/work/data/OUT-mitk/mitk-output-tissuenet2500-INTEN.txt"
resultpath = "/home/kharchenkoa2/work/data/OUT-mitk/mitk_bench_tissuent_fo-fon-foh.csv" # Attention! File name must match the features request in 'cline' below
...
for f in files:	
	...
	try:
		...
		# DEBUG
		print (">errcode=", errcode, "out=", out, "cline=", cline)
