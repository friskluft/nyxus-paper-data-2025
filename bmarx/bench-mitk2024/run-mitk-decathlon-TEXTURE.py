...
outpath = "/home/kharchenkoa2/work/data/OUT-mitk/mitk-output-TEXTURE.txt"
resultpath = "/home/kharchenkoa2/work/data/OUT-mitk/mitk_accuracy_TEXTURE.csv" # Attention! File name must match the features request in 'cline' below
