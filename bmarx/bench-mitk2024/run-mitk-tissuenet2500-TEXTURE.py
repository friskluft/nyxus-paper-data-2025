...
# settings
SDIR = "/home/kharchenkoa2/work/data/tissuenet2500-splitroi-nrrd/seg"	# strongly required: ROIs of a single image there! No other slides!
IDIR = "/home/kharchenkoa2/work/data/tissuenet2500-splitroi-nrrd/int"
MITK_EXE_PATH = "/home/kharchenkoa2/work/mitk/MITK-2016.11.99_r5cccf9-linux64/bin/MitkCLGlobalImageFeatures"
outpath = "/home/kharchenkoa2/work/data/OUT-mitk/mitk-output-tissuenet2500-TEXTURE.txt"
resultpath = "/home/kharchenkoa2/work/data/OUT-mitk/mitk_bench_tissuenet2500_TEXTURE.csv" # Attention! File name must match the features request in 'cline' below
...
for f in files:	
	...
	cline = [
		...
		, "-i", IDIR + "/" + slideName
		, "-m", SDIR + "/" + slideName
		, "-cooc2 -rl -ngld -ngtd -gldz -glsz"	# TEXTURE --- MITK produces no output for glsz, though ---
		#,"-fo", "-fon", "-foh"	# INTEN matches resultpath="c:\\work\\axle\\data\\OUTPUT\\mitk_accuracy_fo-fon-foh.csv"
	]
