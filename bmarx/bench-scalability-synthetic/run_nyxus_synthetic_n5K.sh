...
TIMEFILE="kunstig_tid_n${eyeN}_s1000_usegpu=${USEGPU}.output"

	launchNyx

FPATT="synthetic_nrois=${N}_roiarea=10000\.ome\.tif"
TIMEFILE="kunstig_tid_n${eyeN}_s10000_usegpu=${USEGPU}.output"

	launchNyx

FPATT="synthetic_nrois=${N}_roiarea=100000\.ome\.tif"
TIMEFILE="kunstig_tid_n${eyeN}_s100000_usegpu=${USEGPU}.output"
