...
N="10000"
eyeN="10K" # eye-friendly N

FPATT="synthetic_nrois=${N}_roiarea=10\.ome\.tif"
TIMEFILE="nyxus_synthetic_timing_n${eyeN}_s10.output"

	launchNyx

FPATT="synthetic_nrois=${N}_roiarea=100\.ome\.tif"
TIMEFILE="nyxus_synthetic_timing_n${eyeN}_s100.output"

	launchNyx

# FPATT="synthetic_nrois=${N}_roiarea=500\.ome\.tif"
# TIMEFILE="nyxus_synthetic_timing_n${eyeN}_s500.output"
#
#	launchNyx

FPATT="synthetic_nrois=${N}_roiarea=1000\.ome\.tif"
TIMEFILE="nyxus_synthetic_timing_n${eyeN}_s1000.output"

	launchNyx

FPATT="synthetic_nrois=${N}_roiarea=10000\.ome\.tif"
TIMEFILE="nyxus_synthetic_timing_n${eyeN}_s10000.output"

	launchNyx

FPATT="synthetic_nrois=${N}_roiarea=100000\.ome\.tif"
TIMEFILE="nyxus_synthetic_timing_n${eyeN}_s100000.output"
