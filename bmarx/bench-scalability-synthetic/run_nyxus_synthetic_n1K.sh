...
N="1000"
eyeN="1K" # eye-friendly N
USEGPU="true"

FPATT="synthetic_nrois=${N}_roiarea=100\.ome\.tif"
TIMEFILE="kunstig_tid_n${eyeN}_s100.output"

	launchNyx

FPATT="synthetic_nrois=${N}_roiarea=1000\.ome\.tif"
TIMEFILE="kunstig_tid_n${eyeN}_s1000.output"

	launchNyx

FPATT="synthetic_nrois=${N}_roiarea=10000\.ome\.tif"
TIMEFILE="kunstig_tid_n${eyeN}_s10000.output"

	launchNyx

FPATT="synthetic_nrois=${N}_roiarea=100000\.ome\.tif"
TIMEFILE="kunstig_tid_n${eyeN}_s100000.output"
