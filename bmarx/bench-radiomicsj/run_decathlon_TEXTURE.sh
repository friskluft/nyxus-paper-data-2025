...
#	(2) execute commands:
#	find ./seg -maxdepth 1 -type f |head -100000|xargs cp -t "/home/kharchenkoa2/work/data/decathlon-n/seg"
#	find ./int -maxdepth 1 -type f |head -100000|xargs cp -t "/home/kharchenkoa2/work/data/decathlon-n/int"
#
#
...
printf "***\nJARPATH: $JARPATH \nDATADIR: $DATADIR \nOUTDIR: $OUTDIR \nSETTINGSFILE: $SETTINGSFILE \nElapsed Time: $(($end-$start)) seconds \n" >> decathlon_timing_TEXTURE.output
date
